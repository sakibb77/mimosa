...
export const buttonVariants = cva(
  "inline-block text-center px-6 py-3 rounded-xl border eq font-medium active:scale-105 disabled:border-gray disabled:bg-gray disabled:text-dark disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
